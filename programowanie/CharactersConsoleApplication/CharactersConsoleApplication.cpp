...
// Napisz program, który bêdzie prosić o hasło.
...
void task7()
{
	...
	std::cout << "Podaj tekst aby sprawdziæ w nim ilość spółgłosek i samogłosek: \n";
	std::cin >> textFromUser;
	...
	std::cout << "Samogłosek jest: " << vowels << "\n";
	std::cout << "Spółgłosek jest: " << consonants << "\n";
}

/*
* Poproś użytkownika o wprowadzenie liczby całkowitej w systemie dziesiętnym. Nastêpnie skonwertuj tę liczbę na system dwójkowy (binarny) i wyœwietl wynik.
...
{
	std::string textFromUser;
	std::cout << "Podaj tekst aby sprawdzić czy jest palindromem\n";
	std::cin >> textFromUser;
